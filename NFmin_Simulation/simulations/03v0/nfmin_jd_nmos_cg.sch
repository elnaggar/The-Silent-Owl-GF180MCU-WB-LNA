...
.control
  ...
  echo VDS_set_V W_m L_m VBIAS_set_V VGS_actual_V VDS_actual_V VBS_actual_V ID_A JD_mA_per_um Pdc_mW gm_S gds_S gm_ID_1_per_V ro_Ohm gmro Rin_CG_est_Ohm NFmin_dB NF_dB Rn_Ohm SOpt_real SOpt_imag SOpt_mag > nmos03_cg_full_dense.txt
    ...
    foreach wval 0.22e-6 1e-6 5e-6 10e-6 20e-6
      ...
      foreach lval 0.28e-6 0.36e-6 0.50e-6
        ...
        while k <= 230
          ...
          echo $vdsval $wval $lval $&vbias $vgs_op $vds_op $vbs_op $idn_op $jd_op $pdc_op $gm_op $gds_op $gm_id_op $ro_op $gmro_op $rin_cg_op $&nfmin_val $&nf_val $&rn_val $&sopt_re $&sopt_im $&sopt_mag >> nmos03_cg_full_dense.txt
