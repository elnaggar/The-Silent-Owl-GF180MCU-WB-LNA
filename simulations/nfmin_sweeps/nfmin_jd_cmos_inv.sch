...
C {port_diff.sym} 160 -470 0 0 {name=VPORT1 portnum=1 Z0=50 DCval=0 ACmag=1 ACphase=0 TRANval="PWL(0 0)"}
C {port_diff.sym} 160 -320 0 0 {name=VPORT2 portnum=2 Z0=50 DCval=0 ACmag=1 ACphase=0 TRANval="PWL(0 0)"}
