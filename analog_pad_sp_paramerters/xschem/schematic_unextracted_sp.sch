...
logx=1
logy=0
rawfile=$netlist_dir/sp_unextracted_analog_pad.raw
sim_type=sp
autoload=1
color=4
node=s_1_1}
...
write sp_unextracted_analog_pad.raw
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/sp_unextracted_analog_pad.raw sp"}
...
C {code_shown.sym} 1450 -550 0 0 {name=NGSPICE2
only_toplevel=true
value="
.control
save all
...
wrdata sp_unextracted_analog_pad.csv frequency s11_re s11_im s11_db
