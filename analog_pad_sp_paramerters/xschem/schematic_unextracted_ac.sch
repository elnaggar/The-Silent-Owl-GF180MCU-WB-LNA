...
color=4
node=vin
rawfile=$netlist_dir/ac_unextracted_analog_pad.raw}
...
write ac_unextracted_analog_pad.raw
.endc
" }
C {launcher.sym} 990 -305 0 0 {name=h1
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/ac_unextracted_analog_pad.raw ac"}
