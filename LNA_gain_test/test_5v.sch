...
device=resistor
m=1}
C {vsource.sym} 230 -480 0 0 {name=V3 value=5 savecurrent=false}
...
echo
echo ============================================================
echo 5V COMMON-GATE LNA CHECK
echo Device target: nfet_06v0
echo Target frequency: 2.4 GHz
echo Target gm for 50 ohm CG input: 20 mS
echo ============================================================
...
echo
echo ============================================================
echo EXACT 5V RESULTS AT 2.4 GHz
echo ============================================================
...
echo
echo ============================================================
echo CHECKPOINT GAIN VALUES
echo ============================================================

meas sp s21_500m find s21_db at=500Meg
meas sp s21_1g find s21_db at=1G
meas sp s21_1p5g find s21_db at=1.5G
meas sp s21_2g find s21_db at=2G
meas sp s21_2p4g_check find s21_db at=2.4G
meas sp s21_3g find s21_db at=3G
meas sp s21_4g find s21_db at=4G
meas sp s21_5g find s21_db at=5G
...
wrdata lna_5v_2p4g_check.csv frequency s11_db s21_db s12_db s22_db s11_mag s21_mag s22_mag zin_re zin_im zin_mag zout_re zout_im zout_mag

echo
echo ============================================================
echo 5V CHECK COMPLETE
echo Wrote file:
echo lna_5v_2p4g_check.csv
echo ============================================================
...
footprint=1206
device=inductor}
C {symbols/nfet_05v0.sym} 650 -360 0 0 {name=M2
L=0.60u
W=20u
nf=1
m=13
...
C {symbols/nfet_05v0.sym} 410 -230 0 1 {name=M1
L=0.60u
W=20u
nf=1
m=14
